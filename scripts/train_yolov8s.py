"""
Script train YOLOv8s cho Coffee Bean Ripeness Detection
Dataset: Lam Dong Coffee Bean Ripeness Dataset
Classes: barely-riped, over-riped, riped, semi-riped, unriped

YOLOv8s (small) - Lớn hơn YOLOv8n, accuracy cao hơn nhưng chậm hơn
"""
...
# Training params
IMG_SIZE = 640
BATCH_SIZE = 16  # Có thể giảm xuống 8 nếu OOM
EPOCHS = 100
...
def train():
    ...
    print("=" * 50)
    print(f"Best model saved at: {MODEL_DIR}/yolov8s_coffee/weights/best.pt")
    print(f"Last model saved at: {MODEL_DIR}/yolov8s_coffee/weights/last.pt")
...
def validate():
    ...
    best_model_path = MODEL_DIR / "yolov8s_coffee" / "weights" / "best.pt"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train YOLOv8s for Coffee Bean Detection")
